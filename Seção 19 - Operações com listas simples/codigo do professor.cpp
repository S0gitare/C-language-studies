    ...
    string retornaNomeSequencial(pessoa *&ponteiroSequencial,int *tamanhoDaListaSequencial,int rg){
        ...
        while(funcaoDesejada < 10 && funcaoDesejada > 0){
            ...
            switch(funcaoDesejada){
                ...
                case 7:
                    ...
                    //Retorna o nome pelo RG
                    cout << "Nome:" << retornaNomeSequencial(ponteiroSequencial, &tamanhoDaListaSequencial, rg);
